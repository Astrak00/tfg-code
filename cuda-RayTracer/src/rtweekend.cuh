...
CUDA_CALLABLE_MEMBER inline double random_double(curandState * local_rand_state) {
  return curand_uniform(local_rand_state);
}

CUDA_CALLABLE_MEMBER inline vec3 random_unit_vector(curandState * local_rand_state) {
